...
df_prescript  = pd.read_csv(p / 'all_prescriptions.csv')
# df_uti_features = pd.read_csv(p / 'all_uti_features.csv')
df_uti_resist_lab = pd.read_csv(p / 'all_uti_resist_labels.csv')
data_dict = pd.read_csv(p / 'data_dictionary.csv')

# Test and Train labels and features
test_uncomp_resist_data =  pd.read_csv(p/'test_uncomp_resist_data.csv')
test_uncomp_uti_features =  pd.read_csv(p/'test_uncomp_uti_features.csv')
train_uncomp_resist_data =  pd.read_csv(p/'train_uncomp_resist_data.csv')
train_uncomp_uti_features =  pd.read_csv(p/'train_uncomp_uti_features.csv')
...
val_preds_res = pd.read_csv(p/'val_predictions.csv')
...
test_predictions_opt = pd.read_csv(p/'test_predictions_optimal.csv')
test_predictions_e2e = pd.read_csv(p/'test_predictions_e2e.csv')
...
test_policy_opt = pd.read_csv(p/'test_policy_optimal.csv')
test_policy_e2e = pd.read_csv(p/'test_policy_e2e.csv')
